...
public class SimpleSoundPlayer {
	...
	public static void main(String[] args) {
		...
		SimpleSoundPlayer sound = new SimpleSoundPlayer("C:/Users/Charlie/Desktop/allsrc/ch04src/sounds/voice.wav");
	...
	*/
	...
	public void playMP3orOGG(String location){
	
			AudioFormat playbackFormat = new AudioFormat(44100, 16, 1, true, false);
			// open the source file
			AudioInputStream source = null;
			try {
				source = AudioSystem.getAudioInputStream(new File(location));
